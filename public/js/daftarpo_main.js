        ...
        document.getElementById("detail-content").innerHTML = `
            <div class="detail-grid">
                <div class="detail-section">
                    <h3>Informasi PO</h3>
                    <div class="detail-row"><span class="label">No. PO:</span><span class="value">${po.po_no}</span></div>
                    <div class="detail-row"><span class="label">Tanggal:</span><span class="value">${formatDate(po.tanggal)}</span></div>
                    <div class="detail-row"><span class="label">No. PR:</span><span class="value">${po.pr_no}</span></div>
                    <div class="detail-row"><span class="label">Status:</span><span class="value"><span class="status-badge status-${getStatusClass(po.status)}">${po.status}</span></span></div>
                </div>
                <div class="detail-section">
                    <h3>Vendor</h3>
                    <div class="detail-row"><span class="label">Nama:</span><span class="value">${po.vendor_nama}</span></div>
                    <div class="detail-row"><span class="label">No. HP:</span><span class="value">${po.vendor_hp || "-"}</span></div>
                    <div class="detail-row"><span class="label">Alamat:</span><span class="value">${po.vendor_alamat || "-"}</span></div>
                </div>
            </div>

            <div class="detail-section">
                <h3>Keperluan / Uraian</h3>
                <p>${po.keperluan}</p>
            </div>
            ...
            <div class="detail-section approval-trail">
                <h3>Approval Trail</h3>
                <div class="trail-items">
                    <div class="trail-item ${po.purchaser_name ? 'completed' : ''}">
                        <i class="fa-solid fa-user"></i>
                        <span>Dibuat: ${po.purchaser_name || "-"}</span>
                    </div>
                    <div class="trail-item ${po.manager_ho_name ? 'completed' : ''}">
                        <i class="fa-solid fa-user-tie"></i>
                        <span>Manager HO: ${po.manager_ho_name || "-"}</span>
                        ${po.approval_manager_ho_date ? `<small>${formatDateTime(po.approval_manager_ho_date)}</small>` : ""}
                    </div>
                    <div class="trail-item ${po.direktur_name ? 'completed' : ''}">
                        <i class="fa-solid fa-crown"></i>
                        <span>Direktur: ${po.direktur_name || "-"}</span>
                        ${po.approval_direktur_date ? `<small>${formatDateTime(po.approval_direktur_date)}</small>` : ""}
                    </div>
                </div>
            </div>
        `;
